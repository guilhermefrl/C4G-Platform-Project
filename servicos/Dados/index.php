...
echo '
    <div class=" form-row my-3">
      <div class="text-center w-100">
        <input type="search" class="form-control d-inline-block align-middle w-75" name="Pesquisa_Dados" id="Pesquisa_Dados" placeholder="Pesquise aqui serviços do tipo dados..." onkeyup="$(\'#Pesquisa_Dados ~ [name=search]\').click()">
        <button type="submit" name="search" id="search_btn_dados" class="btn" onclick="pesquisar(\'Pesquisa_Dados\',$(\'#Pesquisa_Dados\').val())">
